...
public final class QueryUtils {
    ...
    private static List<Article> extractResponseFromJson(String articleJSON) {
        ...
        try {
            ...
            //Extract the JSONArray "results" from within the JSONObject articleArray
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                // Extract the value for the key called "webTitle" with represent the article Title
                String articleTitle = currentArticle.getString("webTitle");

                // Extract the value for the key called "sectionName" with represent the section name
                String articleSection = currentArticle.getString("sectionName");

                //Extract the JSONArray "tags" from within the JSONObject currentArticle
                ...
                // Create a new {@link Article} object with the title, section, author, date
                // and url from the JSON response.
                Article article = new Article(articleTitle, articleSection,authorName, articleDate, articleUrl);
